    ...
    <div class="container mx-auto">
        ...
        <section class="py-8 container px-4 mx-auto">
            <div class="bg-white py-4 mb-4 rounded-xl">
                <form action="{{ auth()->user()->isAdmin() ? route('offers.index') : route('offers.my') }}" method="GET" class="flex md:flex-row flex-col gap-8 justify-center">
                    <div class="px-8 py-2 bg-white border border-gray-200 rounded-3xl">
                        ...
                        >
                            ...
                            @foreach(\App\Constans\Status::LIST as $status)
                                <option
                            ...
                            <tr class="border-b border-gray-100">
                                <td class="p-0">
                                    <div
                                       class="flex break-words items-center pl-4">
                                        <img class="w-8 h-8 rounded-full object-cover" src="{{ asset('images/profile_thumbnail.png') }}" alt="User">
                                ...
                                <td class="p-0">
                                    <div class="flex items-center p-5">
                                        @if($offer->status === 'app\Constans\Status::DRAFT')
                                            <span
                                ...
                                <td class="p-0">
                                    <div class="flex items-center justify-center p-5">
                                        <a class="delete-item-btn mr-2 inline-flex w-8 h-8 items-center justify-center bg-red-500 hover:bg-red-600 rounded-2xl"
